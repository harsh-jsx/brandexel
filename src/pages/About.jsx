    ...
    return (
      <span className={`inline-block leading-tight ${className}`}>
        {text.split(" ").map((word, i) => (
          <span
            key={i}
            className="word-wrapper inline-block overflow-hidden mr-[0.2em] -mb-[0.2em]"
          >
...
const About = ({ isPreloading }) => {
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className="bg-[#101010] text-[#E9E4D9] min-h-screen"
      >
        {/* --- HERO SECTION --- */}
        {/* --- HERO SECTION --- */}
        <section
          ref={heroRef}
          className="relative pt-20 md:pt-0 min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-20 overflow-hidden bg-[#101010]"
        >
          {/* Background Elements */}
          ...
          <div
            className="absolute bottom-[-10%] left-[-5%] w-[30vw] h-[30vw] rounded-full border border-[#E9E4D9]/5 animate-spin-slow opacity-30 pointer-events-none"
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center w-full">
            <div className="flex flex-col items-center justify-center leading-[0.8] tracking-tighter text-[#E9E4D9]">
              ...
              <div className="flex items-center justify-center gap-2 md:gap-6 w-full">
                <span className="font-[abc] text-[13.5vw]  md:text-[16vw] uppercase inline-block">
                ...
                <div className="w-[12vw] h-[12vw] md:w-[10vw] md:h-[10vw] rounded-full bg-[#E9E4D9] text-[#101010] flex items-center justify-center rotate-12 shrink-0 mt-[1vw]">
                  <span className="font-[abc] text-[2.5vw] md:text-[2.5vw] tracking-widest">
                    EST.23
                  </span>
                </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-4xl mt-16 md:mt-24 pt-8 border-t border-[#E9E4D9]/20">
              <p className="font-abc text-sm md:text-base uppercase tracking-widest opacity-60">
              ...
              <p className="font-abc max-w-md text-center md:text-right text-lg opacity-80 leading-relaxed mt-4 md:mt-0">
                Defining the aesthetics of the future web.
                <br />
        ...
        <section className="manifesto-section py-32 md:py-56 px-6 md:px-12 lg:px-20 bg-[#E9E4D9] text-[#1a1a1a] relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <p className="font-[druk] text-4xl md:text-7xl leading-[1.1] uppercase text-center">
              ...
              {"Basic exists to be broken. Normal is a curse. We believe that to be seen, you must first have the courage to disappear from the crowd. BrandExel is the glitch in the matrix."
                .split(" ")
                .map((word, i) => (
                  <span
                    key={i}
        ...
        <section className="py-32 px-6 md:px-12 lg:px-20 bg-[#101010] relative overflow-hidden">
          <div className="mb-24 relative z-10">
            <span className="font-abc text-[#E9E4D9] uppercase tracking-[0.2em] text-sm opacity-50">
              Our DNA
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: "Radical Truth",
                desc: "No fluff. No jargon. We strip away the excess to find the core message that actually matters.",
              },
              {
                title: "Design Chaos",
                desc: "Order is boring. We embrace controlled chaos to create visual languages that feel alive and unpredictable.",
              },
              {
                title: "Speed & Soul",
                desc: "We move fast, but we never lose the human touch. Technology is the tool, emotion is the goal.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="value-card border border-[#E9E4D9]/20 p-10 hover:bg-[#E9E4D9] hover:text-[#101010] transition-colors duration-500 group min-h-[400px] flex flex-col justify-between cursor-default"
              >
                ...
                <div>
                  ...
                  <p className="font-abc text-lg opacity-70 group-hover:opacity-100">
                    {item.desc}
                  </p>
                </div>
              </div>
            ...
            {[
              {
                step: "01",
                name: "DISCOVERY",
                desc: "We dig deep. We ask the uncomfortable questions to find the raw truth of your brand.",
              },
              {
                step: "02",
                name: "DIRECTION",
                desc: "We set the visual compass. Moodboards, motion tests, and typographic exploration.",
              },
              {
                step: "03",
                name: "DESIGN",
                desc: "Pixels, vectors, and code. We build the system that will define your future.",
              },
              {
                step: "04",
                name: "DEPLOY",
                desc: "Launch day. We ensure everything is pixel-perfect and ready for the world.",
              },
            ].map((p, i) => (
              <div
                key={i}
                className="process-item group relative border-t border-[#1a1a1a]/20 py-16 px-6 md:px-12 lg:px-20 flex flex-col md:flex-row md:items-start gap-10 hover:bg-white transition-colors duration-300"
              >
                <span className="p-num font-[druk] text-6xl md:text-8xl text-[#1a1a1a]/20 group-hover:text-[#1a1a1a] transition-colors duration-500">
                  {p.step}
                </span>
                <div className="flex-1 pt-4">
                  <h3 className="font-[druk] text-5xl md:text-6xl uppercase mb-4">
                    {p.name}
                  </h3>
                  <p className="font-abc text-xl max-w-lg opacity-70">
                    {p.desc}
                  </p>
                </div>
        ...
        {/* --- TEAM HORIZONTAL --- */}
        <section className="team-section min-h-screen bg-[#101010] text-[#E9E4D9] overflow-x-hidden flex flex-col justify-start md:justify-center py-16 md:py-20 lg:py-24">
          ...
          <div className="team-track flex gap-10 px-6 md:px-12 lg:px-20 w-fit">
            {[
              ...
              {
                name: "SARAH",
                img: "https://picsum.photos/seed/sarah/500/700",
              },
              {
                name: "MARCUS",
                img: "https://picsum.photos/seed/marcus/500/700",
              },
              {
                name: "ELENA",
                img: "https://picsum.photos/seed/elena/500/700",
              },
              ...
              >
                ...
                <div className="mt-4 border-t border-[#E9E4D9] pt-2 flex justify-between items-baseline">
                  <span className="font-[druk] text-4xl uppercase">
                    {m.name}
                  </span>
                  <span className="font-abc text-sm opacity-50">0{i + 1}</span>
                </div>
