      ...
      <div className="px-8 md:px-16 relative z-10" >
        ...
        >
          ...
          >
            {[...marqueeWords, ...marqueeWords].map((word, i) => (
              <span
                key={i}
                className={`font-[druk] text-6xl sm:text-7xl md:text-8xl lg:text-9xl mx-6 md:mx-10 transition-colors duration-300 ${word === "✦" ? "text-4xl sm:text-5xl md:text-6xl" : ""
                  }`}
                style={{
        ...
        <div ref={ctaRef} className="mt-20 md:mt-32 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <button
            ...
            className="px-10 py-5 rounded-full border border-white/20 hover:bg-[#AF986A] hover:text-white hover:scale-110 transition-all duration-300"
            fillColor="#AF986A"
          >
